...
import { getProductName } from "@/lib/product-names-server"
...
export default async function ProductDetailPage({ params }: Props) {
  ...
  const tListing = await getTranslations({ locale, namespace: "productListing" })
    ...
    <main className="bg-background">
      <div className="pt-20">
        ...
        <div className="border-t py-12">
          <ProductListing
            title={tListing("relatedTitle")}
            description={tListing("relatedDescription")}
