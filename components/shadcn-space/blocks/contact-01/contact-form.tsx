          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="flex flex-col gap-8">
              ...
              >
                ...
                <span className="absolute right-1 flex h-10 w-10 items-center justify-center rounded-full bg-background text-foreground transition-all duration-500 group-hover:right-[calc(100%-40px)] group-hover:rotate-45">
